    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button_pairing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(BluetoothCommunicationActivity.this, BluetoothConnectActivity.class));
            }
        });
        ...
        thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while(!Thread.currentThread().isInterrupted()) {
                    ...
                    // 문자열 개수를 받아옴
                    try {
                        byteAvailabe = BluetoothConnectActivity.inputStream.available();
                    }
                    catch (IOException e) {
                        e.printStackTrace();
                    }
                    ...
                    if(byteAvailabe > 0) {
                        ...
                        // 바이트 배열 크기만큼 읽어옴
                        try {
                            BluetoothConnectActivity.inputStream.read(packetByte);
                        }
                        catch (IOException e) {
                            e.printStackTrace();
                        }
